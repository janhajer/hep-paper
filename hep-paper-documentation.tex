...
The |\underline| macro is redefined to allow linebreaks using the |ulem| package \cite{ulem}.
...
The |\shortacronym| and |\longacronym| macros are dropin replacements of the |\acronym| macro showing only the short or long form of their acronym.
